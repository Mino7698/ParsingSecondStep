...
public class CustomerFilterServiceTest {
    ...
    public void creatingListOfCustomers() {
        ...
        Operation operation1 = Operation.builder().currency(Currency.USD).value(1471.0).build();
        ...
        Operation operation33 = Operation.builder().currency(Currency.USD).value(1.0).build();
        Operation operation44 = Operation.builder().currency(Currency.USD).value(2.0).build();
        Operation operation55 = Operation.builder().currency(Currency.USD).value(3.0).build();
        Operation operation66 = Operation.builder().currency(Currency.USD).value(4.0).build();
        ...
        Operation operation2 = Operation.builder().currency(Currency.USD).value(1470.0).build();
        ...
        Operation operation3 = Operation.builder().currency(Currency.USD).value(100500.0).build();
        Operation operation4 = Operation.builder().currency(Currency.USD).value((double) -111555).build();
